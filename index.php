                    ...
                    <div class="col-md-6">
                        <div class="features-box">
                            ...
                            <div class="features-text"><h5>Landing page под ключ</h5>
                                <p>Индивидуальный landing page
                                    для вашего бизнеса за 5-8 дней
                        ...
                        <div class="features-box">
                            ...
                            <div class="features-text"><h5>Дизайн из каталога</h5>
                                <p>Создайте сайт с одним из уникальных дизайнов в нашем каталоге. Мы внесем в
                                    оформление: Ваш логотип,
                                    фирменные цвета, телефон и адрес и запустим Ваш сайт с этим дизайном.</p></div>
                        </div>
                    </div>
                </div>
            </div>
