                    ...
                    <div class="col-md-6">
                        ...
                        <div class="features-box">
                            ...
                            <div class="features-text"><h5>Верстка сайта из PSD </h5>
                                <p>Верстка современных интерфейсов с полным погружением в задачу клиента.
                                    Ни один пиксель не пострадает! Хотите заказать качественную адаптивную верстку? Это
                                    к нам.
                        ...
                        <div class="features-box">
                            ...
                            <div class="features-text"><h5>Дизайн из каталога</h5>
                                <p>Создайте сайт с одним из 10 000 уникальных дизайнов в нашем каталоге. Мы внесем в
                                    оформление: Ваш логотип,
                                    фирменные цвета, телефон и адрес и запустим Ваш сайт с этим дизайном. После этого
                                    дизайн будет снят с продажи
                        ...
                        <div class="col-md-4">
                            <div class="features-box">
                                ...
                                <div class="features-text"><h5>Кроссбраузерность сайта</h5>
                                    <p>Кроссбраузерная верстка – это работа над шаблоном сайта, чтобы он одинаково
                                        отображался во всех браузерах.
                                        Существуют определенные стандарты верстки, но почему-то некоторые браузеры
                                        «отстают» от них или не хотят ими руководствоваться.
                                    </p></div>
                            </div>
                        </div>
                            ...
                            <div class="features-box">
                                ...
                                <div class="features-text"><h5>SEO продвижение</h5>
                                    <p>Мы сравниваем SEO с занятиями в спортивном зале. Нужно долго и упорно заниматься,
                                        чтобы получить результат. Но он будет впечатляющим. Все конкуренты обзавидуются
                                        . Практикуем.</p></div>
                            </div>
                        </div>
                        <div class="col-md-4">
