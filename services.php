                        ...
                        <div class="features-box">
                            ...
                            <div class="features-text"><h5>Заказать Логотип</h5>
                                <p>МЫ РАБОТАЕМ С МАЛЫМ И СРЕДНИМ БИЗНЕСОМ,
                                    потребности наших клиентов делятся на две соответствующие категории, поэтому мы разработали два разных подхода.</p></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="features-box">
                            ...
                            <div class="features-text"><h5>Графический дизайн</h5>
                                <p>Немалый опыт работы в рекламной среде, использование новейших
                                    программных разработок позволяют решение вопроса, создавая уникальный дизайн продукции для любого заказа.</p></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="features-box">
                            ...
                            <div class="features-text"><h5>Заказать иллюстрацию</h5>
                                <p>Заказать иллюстрацию здесь даже проще, чем купить наушники в интернет-магазине.
                                    Адекватные цены, скорость исполнения, а главное, 100% гарантия возврата средств!</p></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="features-box">
