...
<section class="banner-sec">
    <div class="inner-banner"
        ...
        <div class="overlay-mask">
            <div class="container"><h2>Услуги</h2></div>
        </div>
    </div>
</section>
        ...
        <div class="services-area-sec">
            <div class="container">
                <div class="service-area-heading">
                    <div class="col-md-12">
                        <div class="main-title"><h3> Our Services </h3></div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="col-md-4">
                        <div class="features-box">
                            ...
                            <div class="features-text"><h5>Logo Design</h5>
                    ...
                    <div class="col-md-4">
                        <div class="features-box">
                            ...
                            <div class="features-text"><h5>Graphic Design</h5>
                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
                                    laudantium, totam rem aperiam.</p></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="features-box">
                            ...
                            <div class="features-text"><h5>Responsive Design</h5>
                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
                                    laudantium, totam rem aperiam.</p></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="features-box">
                            ...
                            <div class="features-text"><h5>SEO</h5>
                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
                                    laudantium, totam rem aperiam.</p></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="features-box">
                            ...
                            <div class="features-text"><h5>Photography</h5>
                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
                                    laudantium, totam rem aperiam.</p></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="features-box">
                            ...
                            <div class="features-text"><h5>Email Marketing</h5>
                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
                                    laudantium, totam rem aperiam.</p></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="features-box">
                            ...
                            <div class="features-text"><h5>Server Support</h5>
                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
                                    laudantium, totam rem aperiam.</p></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="features-box">
                            ...
                            <div class="features-text"><h5>eCommerce</h5>
                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
                                    laudantium, totam rem aperiam.</p></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="features-box">
                            ...
                            <div class="features-text"><h5>Mobile Apps</h5>
                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
                                    laudantium, totam rem aperiam.</p></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="features-box">
                            ...
                            <div class="features-text"><h5>Content Writing</h5>
                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
                                    laudantium, totam rem aperiam.</p></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="features-box">
                            ...
                            <div class="features-text"><h5>Blogs</h5>
                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
                                    laudantium, totam rem aperiam.</p></div>
                        </div>
                    </div>
